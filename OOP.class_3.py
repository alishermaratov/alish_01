"""класс наследования
постараемся сделать второй класс наследую класс машина
которую создавали на прошлом уроке"""
...
tesla = electrik_car("tesla", "model s", 2019)
tesla.battery.descripshon_battery()
# print(tesla.description_name())
# tesla.descripshon_battery()
